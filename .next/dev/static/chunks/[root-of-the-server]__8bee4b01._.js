...
const AdminStateExplorer = ()=>{
    ...
    const [panelPosition, setPanelPosition] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminStateExplorer.useEffect": ()=>{
    ...
    const handleStateSelectFromGlobe = (id, name, coords)=>{
        ...
        if (("TURBOPACK compile-time value", "object") === 'undefined' || !coords) return;
        ...
        let x = Math.max(vw - panelWidth - padding, Math.min(coords.x + 24, vw - panelWidth - padding));
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        ...
        children: [
                            ...
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                onClick: ()=>{
                                    ...
                                    if ("TURBOPACK compile-time truthy", 1) {
                                        ...
                                        const height = 260;
                                        const padding = 16;
                                        const x = Math.min(260, vw - width - padding);
                                        const y = Math.min(vh / 2 - height / 2, vh - height - padding);
                                        setPanelPosition({
                                            x,
                                            y
                                        });
            ...
            selected.name && panelPosition && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: [
                    ...
                    activeSnapshot && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(AdminStateExplorer, "y7X7bZX2oDqHshV9T2DszVqf1YU=");
