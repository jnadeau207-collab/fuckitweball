module.exports = [
  ...
  (__turbopack_context__, module, exports) => {
    const mod = __turbopack_context__.x('@prisma/client', () =>
      require('@prisma/client'),
    );

    module.exports = mod;
  },
  '[externals]/next-auth/next [external] (next-auth/next, cjs)',
  (__turbopack_context__, module, exports) => {
    const mod = __turbopack_context__.x('next-auth/next', () =>
      require('next-auth/next'),
    );

    module.exports = mod;
  },
  '[externals]/next-auth [external] (next-auth, cjs)',
  (__turbopack_context__, module, exports) => {
    const mod = __turbopack_context__.x('next-auth', () =>
      require('next-auth'),
    );

    module.exports = mod;
  },
  '[externals]/next-auth/providers/credentials [external] (next-auth/providers/credentials, cjs)',
  (__turbopack_context__, module, exports) => {
    const mod = __turbopack_context__.x('next-auth/providers/credentials', () =>
      require('next-auth/providers/credentials'),
    );

    module.exports = mod;
  },
  '[externals]/bcrypt [external] (bcrypt, cjs)',
  (__turbopack_context__, module, exports) => {
    const mod = __turbopack_context__.x('bcrypt', () => require('bcrypt'));

    module.exports = mod;
  },
  '[project]/pages/api/auth/[...nextauth].ts [api] (ecmascript)',
  (__turbopack_context__) => {
    ...
    var __TURBOPACK__imported__module__$5b$externals$5d2f$next$2d$auth__$5b$external$5d$__$28$next$2d$auth$2c$__cjs$29$__ =
      __turbopack_context__.i(
        '[externals]/next-auth [external] (next-auth, cjs)',
      );
    var __TURBOPACK__imported__module__$5b$externals$5d2f$next$2d$auth$2f$providers$2f$credentials__$5b$external$5d$__$28$next$2d$auth$2f$providers$2f$credentials$2c$__cjs$29$__ =
      __turbopack_context__.i(
        '[externals]/next-auth/providers/credentials [external] (next-auth/providers/credentials, cjs)',
      );
    ...
    const authOptions = {
      ...
      providers: [
        (0,
        __TURBOPACK__imported__module__$5b$externals$5d2f$next$2d$auth$2f$providers$2f$credentials__$5b$external$5d$__$28$next$2d$auth$2f$providers$2f$credentials$2c$__cjs$29$__[
          'default'
        ])({
          name: 'Credentials',
          credentials: {
    ...
    __TURBOPACK__imported__module__$5b$externals$5d2f$next$2d$auth__$5b$external$5d$__$28$next$2d$auth$2c$__cjs$29$__[
      'default'
    ])(authOptions);
  },
  '[project]/lib/parsers/nova.ts [api] (ecmascript)',
  (__turbopack_context__) => {
    'use strict';
  ...
  '[project]/lib/parsers/index.ts [api] (ecmascript)',
  (__turbopack_context__) => {
    'use strict';
    ...
    var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$parsers$2f$nova$2e$ts__$5b$api$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i(
        '[project]/lib/parsers/nova.ts [api] (ecmascript)',
      );
    function parseWithLabSpecificParsers(text) {
      ...
      if (
        (0,
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$parsers$2f$nova$2e$ts__$5b$api$5d$__$28$ecmascript$29$__[
          'isNovaLabsCoa'
        ])(text)
      ) {
        return (0,
  ...
  '[externals]/multer [external] (multer, cjs)',
  (__turbopack_context__, module, exports) => {
    const mod = __turbopack_context__.x('multer', () => require('multer'));

    module.exports = mod;
  },
  '[externals]/pdf-parse [external] (pdf-parse, cjs)',
  (__turbopack_context__, module, exports) => {
    const mod = __turbopack_context__.x('pdf-parse', () =>
      require('pdf-parse'),
    );
  ...
  '[project]/pages/api/admin/uploads.ts [api] (ecmascript)',
  (__turbopack_context__) => {
    'use strict';

    __turbopack_context__.s(['config', () => config, 'default', () => handler]);
    var __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__ =
      __turbopack_context__.i(
        '[externals]/@prisma/client [external] (@prisma/client, cjs)',
      );
    var __TURBOPACK__imported__module__$5b$externals$5d2f$next$2d$auth$2f$next__$5b$external$5d$__$28$next$2d$auth$2f$next$2c$__cjs$29$__ =
      __turbopack_context__.i(
        '[externals]/next-auth/next [external] (next-auth/next, cjs)',
      );
    var __TURBOPACK__imported__module__$5b$project$5d2f$pages$2f$api$2f$auth$2f5b2e2e2e$nextauth$5d2e$ts__$5b$api$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i(
        '[project]/pages/api/auth/[...nextauth].ts [api] (ecmascript)',
      );
    var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$parsers$2f$index$2e$ts__$5b$api$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i(
        '[project]/lib/parsers/index.ts [api] (ecmascript)',
      );
    // @ts-ignore - multer types are optional
    var __TURBOPACK__imported__module__$5b$externals$5d2f$multer__$5b$external$5d$__$28$multer$2c$__cjs$29$__ =
      __turbopack_context__.i('[externals]/multer [external] (multer, cjs)');
    // @ts-ignore - pdf-parse types are optional
    var __TURBOPACK__imported__module__$5b$externals$5d2f$pdf$2d$parse__$5b$external$5d$__$28$pdf$2d$parse$2c$__cjs$29$__ =
      __turbopack_context__.i(
        '[externals]/pdf-parse [external] (pdf-parse, cjs)',
      );
    ...
    async function requireAdmin(req, res) {
      ...
      __TURBOPACK__imported__module__$5b$externals$5d2f$next$2d$auth$2f$next__$5b$external$5d$__$28$next$2d$auth$2f$next$2c$__cjs$29$__[
        'getServerSession'
      ])(
        req,
        res,
    ...
    const storage =
      __TURBOPACK__imported__module__$5b$externals$5d2f$multer__$5b$external$5d$__$28$multer$2c$__cjs$29$__[
        'default'
      ].diskStorage({
    ...
    async function handler(req, res) {
      ...
      if (req.method === 'POST') {
        try {
          ...
          const pdfData = await (0,
          __TURBOPACK__imported__module__$5b$externals$5d2f$pdf$2d$parse__$5b$external$5d$__$28$pdf$2d$parse$2c$__cjs$29$__[
            'default'
          ])(dataBuffer);
          const text = pdfData.text || '';
          // 1) Try lab-specific parser first
          const labParsed = (0,
          __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$parsers$2f$index$2e$ts__$5b$api$5d$__$28$ecmascript$29$__[
            'parseWithLabSpecificParsers'
          ])(text);
          ...
          const effective = {
            ...
            thcPercent:
              labParsed?.thcPercent ?? genericParsed.thcPercent ?? null,
            cbdPercent:
              labParsed?.cbdPercent ?? genericParsed.cbdPercent ?? null,
            totalCannabinoidsPercent:
