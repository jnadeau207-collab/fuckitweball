module.exports = [
  ...
  '[project]/lib/coaParser.ts [api] (ecmascript)',
  (__turbopack_context__) => {
    'use strict';

    // lib/coaParser.ts
    __turbopack_context__.s(['parseCoaText', () => parseCoaText]);
    /**
     ...
     */ function detectFailures(text) {
      ...
      for (const line of lines) {
        ...
        if (lower.includes('mycotoxin')) category = 'Mycotoxins';
          ...
          lower.includes('hop latent viroid') ||
        ...
        const analyteMatch = line.match(
          /^([A-Z0-9\-\.\s]+?)(\d|<|N|P|F|μ|µ|$)/i,
        );
        const analyte = analyteMatch
          ? analyteMatch[1].trim()
          : 'Unknown analyte';
        failures.push({
          analyte,
    ...
    function parseCoaText(raw) {
      ...
      const totalTerpenesPercent =
        matchNumber(text, /TOTAL TERPENES\s*([0-9]+(?:\.[0-9]+)?)\s*%/i) ??
        null;
      const moisturePercent =
        matchNumber(text, /MOISTURE\s*([0-9]+(?:\.[0-9]+)?)\s*%/i) ?? null;
      const waterActivity =
        matchNumber(text, /WATER ACTIVITY\s*([0-9]+(?:\.[0-9]+)?)\s*Aw/i) ??
        null;
  ...
  '[project]/pages/api/admin/uploads/[id].ts [api] (ecmascript)',
  (__turbopack_context__) => {
    'use strict';

    // pages/api/admin/uploads/[id].ts
    __turbopack_context__.s(['default', () => handler]);
    var __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__ =
      __turbopack_context__.i(
        '[externals]/@prisma/client [external] (@prisma/client, cjs)',
      );
    ...
    var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$coaParser$2e$ts__$5b$api$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i('[project]/lib/coaParser.ts [api] (ecmascript)');
      ...
      if (req.method === 'GET') {
        try {
          ...
          const parseResult = rawText
            ? (0,
              __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$coaParser$2e$ts__$5b$api$5d$__$28$ecmascript$29$__[
                'parseCoaText'
              ])(rawText)
            : null;
