...
"[project]/pages/api/admin/batches/[id].ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    try {
        ...
        const response = {
            ...
            primaryCategory: batch.primaryCategory ?? batch.productCategory ?? null,
            subCategory: batch.subCategory ?? batch.productSubcategory ?? null,
            brand: batch.brand ? {
                id: batch.brand.id,
                name: batch.brand.name
            } : null,
            harvestDate: batch.harvestDate ? batch.harvestDate.toISOString() : null,
            productionDate: batch.productionDate ? batch.productionDate.toISOString() : null,
            packageDate: batch.packageDate ? batch.packageDate.toISOString() : null,
